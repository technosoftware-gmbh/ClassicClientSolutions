...
The OPC Classic Client Solution One-time fee for lifetime SCLA 1.0 license is available at

 * [OPC Classic Client Solution](https://technosoftware.com/product/opc-classic-client-solution/)
...
You must agree to the contributor license agreement before we can accept your changes. The CLA and "I AGREE" button is automatically displayed when you perform the pull request. You can preview CLA [here](https://cla-assistant.io/technosoftware-gmbh/ClassicClientSolutions).
